...
- Um relatório por atividade em `docs/reports/`, usando o `TEMPLATE.md`; preencher após a atividade. Um arquivo por atividade, sem agrupar atividades no mesmo relatório. Atividades de verificação (T02, T45, T53) geram relatório curto com o checklist preenchido.
